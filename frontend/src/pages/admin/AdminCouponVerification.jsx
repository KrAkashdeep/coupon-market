                                        ...
                                        <div className="lg:col-span-1">
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className={`border rounded-lg p-3 ${coupon.isOCRMatched
                                                        ? 'bg-green-50 border-green-200'
                                                        : 'bg-red-50 border-red-200'
                                                        }`}>
                                                        <code className={`text-xs font-mono ${coupon.isOCRMatched
                                                            ? 'text-green-900'
                                                            : 'text-red-900'
                                                            }`}>
                                                            {coupon.ocrExtractedCode || 'No text extracted'}
                                                        </code>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex items-center">
                                                    {coupon.isOCRMatched ? (
                                                        <div className="flex items-center text-green-700">
                                                            ...
                                                            <span className="text-sm font-medium">Code Match</span>
                                                        </div>
                                                    ) : (
                                                        <div className="flex items-center text-red-700">
                                                            ...
                                                            <span className="text-sm font-medium">Code Mismatch</span>
                                                        </div>
                                                    )}
                                                </div>
                                            </div>
