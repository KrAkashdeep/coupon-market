...
function DisplayCard({
    ...
    return (
        <div
            className={`relative flex h-36 w-[32rem] -skew-y-[7deg] select-none flex-col justify-between rounded-xl border-2 bg-slate-100/70 backdrop-blur-sm px-4 py-3 transition-all duration-700 after:absolute after:-right-1 after:top-[-5%] after:h-[110%] after:w-[20rem] after:bg-gradient-to-l after:from-white after:to-transparent after:content-[''] hover:border-white/20 hover:bg-slate-100 [&>*]:flex [&>*]:items-center [&>*]:gap-2 ${className}`}
        >
            <div>
